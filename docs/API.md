...
Google OAuth を Authorization Code + PKCE で開始します。利用には `GOOGLE_OAUTH_ENABLED=true`、`GOOGLE_OAUTH_CLIENT_ID`、`GOOGLE_OAUTH_CLIENT_SECRET`、`APP_PUBLIC_ORIGIN` が必要です。
